...
//         console.log("Loaded sidebar state from local storage:", savedState, savedCollapsedState) // Debug log
//         if (savedState !== null) {
...
//         fixed bottom-0 left-0 w-full h-[60px] border-t ${isOpen ? "md:w-[250px] md:px-4" : "md:w-[60px] md:px-[5px]"}`}
//             >

//                 <ul className="list-none p-0 flex md:flex-col md:overflow-hidden overflow-x-auto">
//                     <li className=" md:flex md:justify-end md:mb-4">
//                         <span className={`font-semibold ${collapsed ? "hidden" : ""}`}>OpenBlogAI</span>
//                         <span>test</span>
//                         <ToggleButton onClick={toggleSidebar} isOpen={isOpen} />
//                     </li>
//                     <SidebarItem href="index.html" icon="home" text="Home" collapsed={collapsed} />
//                     <SidebarItem href="dashboard.html" icon="dashboard" text="Dashboard" collapsed={collapsed} />
//                     <SidebarItem
//                         icon="create"
//                         text="Create"
//                         isSubmenu
...
//                         collapsed={collapsed}
//                     />
//                     <SidebarItem href="calendar.html" icon="calendar" text="Calendar" active collapsed={collapsed} />
//                     <SidebarItem href="profile.html" icon="profile" text="Profile" collapsed={collapsed} />
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      <nav
        className={`duration-300 ease-in-out overflow-hidden 
                    md:sticky md:top-0 md:h-screen md:border-r md:border-t-0
                    fixed bottom-0 left-0 w-full h-[60px] border-t ${
                      isOpen
                        ? "md:w-[250px] md:px-4"
                        : "md:w-[60px] md:px-[5px]"
                    }`}
  ...
  <div className="flex justify-between items-center mb-4">
    <span
      className={`font-semibold mt-4 font-title inline-flex text-lg md:text-2xl ${
