                ...
                >
                    ...
                    >
                        ...
                        <p className="text-slate-600 mb-6">
                            Something went wrong on our end. We are working to fix the issue. Please try again later or contact support if the problem persists.
                        </p>
                    </motion.div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link href="/" className="flex-1">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-slate-600 to-slate-700 text-white rounded-xl hover:from-slate-700 hover:to-slate-800 transition-all duration-300 font-medium w-full"
                                >
                                    <FiHome size={18} />
                                    Home Page
                                </motion.button>
                            ...
                            <Link href="mailto:support@openblogai.com" className="flex-1">
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="flex items-center justify-center gap-2 px-6 py-3 border-2 border-purple-600 text-purple-600 rounded-xl hover:bg-purple-600 hover:text-white transition-all duration-300 font-medium w-full"
                                >
                                    <FiMail size={18} />
                                    Contact Support
                                </motion.button>
