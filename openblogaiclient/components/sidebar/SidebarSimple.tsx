...
export const SidebarSimple: React.FC = () => {
    ...
    return (
        <div className="min-h-full w-64 bg-base-100">
            {/* Header */}
            <div className="p-6 border-b border-base-300">
                <h1 className="text-xl font-bold">OpenBlogAI</h1>
                <p className="text-sm opacity-60">AI Blog Generator</p>
            </div>
                ...
                <li>
                    <Link href="/dashboard">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m7 7 10 10M17 7l-10 10" />
                        </svg>
                        Dashboard
                    </Link>
                </li>
